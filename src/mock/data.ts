...
export const cards = [
  ...
  { id: '14', title: '读书会', place: '徐汇 · 2.2km', name: '书虫', price: 50, avatar: avatars[5], image: '/categories/学习.png', desc: '每周读书会，分享阅读心得', category: '兴趣' },
...
export const blindBoxPrizes = [
  ...
  { id: 8, name: '神秘大奖', icon: '/categories/更多.png', type: 'mystery', value: 1 },
];
